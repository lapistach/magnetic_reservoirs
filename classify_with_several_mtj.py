...
def main():
    ...
    samples_number = 24
    test_ratio = 0.2
    X_train, X_test, y_train, y_test, _, _ = ds.periodic_classification_01_011(samples_number, 60, test_ratio)
    ...
    list_of_mtjs = {
                ...
                "neuron no1": [-2.0, 1.0, 0.9, 0.9, True, 'none'],
                "neuron no2": [-2.5, 1.0, 0.7, 0.9, True, 'none'],
                "neuron no3": [],
                "neuron no4": [],
                "neuron no5": [],
                "neuron no6": [],
    ...
    file.write("Number of features: " + str(n_features//n_neurons) + "\n")
    file.write("Number of neurons: " + str(n_neurons) + "\n")
    file.write("Number of total features: " + str(n_features) + "\n")
